...
if (mq.matches) {
  ...
  //Menübutton mobile Website---Menü öffnen+Menübutton rotieren
    $(document).ready(function(){
      $('.menubutton').click(function(){
        $('nav').slideToggle('slow');
        $('.menubutton').toggleClass('menubutton-clicked');
